...
def customAlgorithm(trainingData, users, cfg):
	...
	cfgs.append(cfg_pearson_amplify)
	...
	cfgs.append(cfg_pearson_IUF_amplify)
	'''
	...
	for c in cfgs:
		...
		if(c[0]["filtering_algorithm"]=="user-based"):
			tempPredictions[count] = ub_filtering.userBasedCollaborativeFiltering(trainingData, users, c[0]["user-based"])
